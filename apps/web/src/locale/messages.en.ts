...
export const en = {
  ...
  configForms: {
    ...
    dbQuery: {
      ...
      modeVisual: 'Builder',
      modeVisualHint:
        'Pick a data source and fields, and we will generate the SQL.',
      modeRawSql: 'Write SQL',
      modeRawSqlHint:
        'Use this for complex queries or when you prefer to work directly with SQL.',
      selectTable: 'Data source',
      loadingTables: 'Loading tables\u2026',
      noTables: 'No available tables or views were found.',
      sourceCount: (count: number) => `${count} available source(s) found`,
      ...
      selectConnectionHint:
        'Choose a PostgreSQL connection to open the query builder.',
      showJson: 'Step JSON',
    ...
    rawJson: {
      ...
      invalidJson: 'Invalid JSON',
      expertEyebrow: 'Advanced mode',
      expertDescription:
        'Open step JSON only when the visual form is not enough.',
    },
    templatedInput: {
