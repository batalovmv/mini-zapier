...
export const en = {
  ...
  configPanel: {
    ...
    nodeSettingsEyebrow: 'What this step should do',
    nodeSettingsDescription:
      'Fill in the required fields first. Advanced modes stay lower in the form.',
    ...
    dangerZoneDescription:
      'Remove this step only if you no longer need it in the chain.',
  ...
  configForms: {
    ...
    dataTransform: {
      mode: 'How to build the result',
      modeAriaLabel: 'Data Transform mode',
      templateMode: 'Template text/JSON',
      mappingMode: 'Fields one by one',
      ...
      remove: 'Remove',
      templateModeHint:
        'Use this when you want to build text or JSON from one template.',
      mappingModeHint:
        'Use this when you want to build an object field by field.',
      showJson: 'Manual JSON',
      hideJson: 'Hide manual JSON',
    },
    dbQuery: {
      query: 'Manual SQL',
      ...
      modeVisual: 'Build query',
      modeRawSql: 'Manual SQL',
      selectTable: 'Which table to use',
      loadingTables: 'Loading tables\u2026',
      noTables: 'No available tables were found.',
      columns: 'Which fields to return',
      allColumns: 'All columns',
      loadingColumns: 'Loading columns\u2026',
      filters: 'Which rows to target',
      ...
      sqlPreview: 'Final query',
      testButton: 'Check query',
      testRunning: 'Running\u2026',
      testResult: 'Result',
      testRowCount: (count: number) => `${count} row(s) returned`,
      testError: 'Check failed',
      selectConnectionHint:
        'Select a PostgreSQL connection and we will build the query visually.',
      showJson: 'Tech JSON',
      hideJson: 'Hide tech JSON',
      introspectionError: 'Could not load tables and columns.',
      metadataUnavailable:
        'Visual PostgreSQL setup is not available in this service version yet. You can switch to manual SQL.',
      testUnavailable:
        'SQL checks from the editor are not available in this service version yet. Run the workflow normally instead.',
      switchToRawSql: 'Switch to manual SQL',
      opSelect: 'Read',
      opInsert: 'Add',
      opUpdate: 'Edit',
      opDelete: 'Delete',
      setValues: 'What to write',
    ...
    rawJson: {
      ...
      invalidJson: 'Invalid JSON',
      expertEyebrow: 'For advanced users',
      expertDescription:
        'Open manual JSON only when the visual form is not enough.',
    },
    templatedInput: {
      editAsCode: 'Edit manually',
      visualMode: 'Back to visual mode',
