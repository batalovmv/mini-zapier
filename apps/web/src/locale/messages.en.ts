...
export const en = {
  ...
  stepTest: {
    ...
    sectionDescription: 'Run this step with sample data to verify configuration.',
    ...
    noConnectionWarning: 'Select a connection before testing.',
  ...
  configForms: {
    ...
    dbQuery: {
      ...
      selectConnectionHint:
        'Select a PostgreSQL connection to use the visual builder.',
      ...
      addSetValue: 'Add value',
      removeSetValueAriaLabel: 'Remove value',
      setValueColumn: 'Column',
      setValuePlaceholder: 'Value',
      testMutationResult: (count: number) =>
        `${count} row(s) would be affected (rolled back)`,
      deleteNoFilterWarning: 'DELETE without filters will affect all rows.',
      updateNoFilterWarning: 'UPDATE without filters will affect all rows.',
    },
    emailAction: {
      to: 'To',
