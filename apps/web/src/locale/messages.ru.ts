...
export const ru = {
  ...
  configForms: {
    ...
    availableFields: {
      eyebrow: 'Доступные поля',
      description: 'Поля из результата предыдущего шага.',
      emptyHint: 'Запустите предыдущий шаг, чтобы увидеть доступные поля.',
      sourceTest: 'Из тестового запуска',
      sourceExecution: 'Из последнего выполнения',
      loading: 'Загрузка…',
    },
    messagePreview: {
      toggle: 'Предпросмотр',
