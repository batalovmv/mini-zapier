...
export const ru = {
  ...
  configPanel: {
    ...
    nodeSettingsEyebrow: 'Что должен сделать шаг',
    nodeSettingsDescription:
      'Заполните обязательные поля. Продвинутые режимы спрятаны ниже в форме.',
    ...
    dangerZoneEyebrow: 'Опасная зона',
    dangerZoneDescription:
      'Удаляйте шаг только если он больше не нужен в цепочке.',
  ...
  stepTest: {
    sectionEyebrow: 'Проверка шага',
    sectionDescription:
      'Запустите шаг на тестовых данных и сразу посмотрите результат.',
    testButton: 'Запустить проверку',
    testRunning: 'Выполняется...',
    testButtonSaveFirst:
      'Сначала сохраните сценарий, потом можно запускать проверку.',
  ...
  configForms: {
    ...
    dataTransform: {
      ...
      templateMode: 'Шаблон текста/JSON',
      mappingMode: 'Поля по отдельности',
      ...
      remove: 'Удалить',
      templateModeHint:
        'Подходит, когда нужно собрать текст или JSON одним шаблоном.',
      mappingModeHint:
        'Подходит, когда нужно собрать объект из отдельных полей.',
      showJson: 'JSON вручную',
      hideJson: 'Скрыть JSON вручную',
    },
    dbQuery: {
      query: 'SQL-запрос',
      ...
      modeVisualHint:
        'Выберите источник данных и нужные поля, а SQL соберём автоматически.',
      modeRawSql: 'Написать SQL',
      modeRawSqlHint:
        'Подходит для сложных запросов или когда удобнее работать напрямую с SQL.',
      selectTable: 'Источник данных',
      loadingTables: 'Загрузка таблиц\u2026',
      noTables: 'Не нашли доступные таблицы или представления.',
      sourceCount: (count: number) =>
        `Найдено ${count} доступных источников данных`,
      columns: 'Какие поля вернуть',
      allColumns: 'Все колонки',
      loadingColumns: 'Загрузка колонок\u2026',
      filters: 'Какие строки выбрать',
      ...
      orderBy: 'Как отсортировать',
      orderAsc: 'ASC',
      orderDesc: 'DESC',
      limit: 'Сколько строк вернуть',
      sqlPreview: 'SQL, который выполнится',
      ...
      selectConnectionHint:
        'Выберите PostgreSQL-подключение, чтобы открыть конструктор запроса.',
      showJson: 'JSON шага',
      ...
      switchToRawSql: 'Написать SQL',
      opSelect: 'Чтение',
      opInsert: 'Добавление',
      opUpdate: 'Обновление',
      opDelete: 'Удаление',
      setValues: 'Что записать',
    ...
    httpRequest: {
      ...
      editBodyAsJson: 'JSON вручную',
      editBodyAsFields: 'Поля',
      contentTypeHint:
        'Если Content-Type не задан, добавим application/json автоматически',
      showJson: 'JSON вручную',
      hideJson: 'Скрыть JSON вручную',
      showAdvancedHeaders: 'Показать',
      hideAdvancedHeaders: 'Скрыть',
      headersHint:
        'Обычно не нужны. Открывайте только если сервис требует специальные заголовки.',
      remove: 'Удалить',
    },
    telegram: {
      chatId: 'Chat ID',
    ...
    rawJson: {
      ...
      invalidJson: 'Невалидный JSON',
      expertEyebrow: 'Расширенный режим',
      expertDescription:
        'Открывайте JSON шага только если визуальной формы не хватает.',
    },
    templatedInput: {
      editAsCode: 'Править вручную',
      visualMode: 'Вернуться к визуальному режиму',
      fieldPath: 'Путь поля',
