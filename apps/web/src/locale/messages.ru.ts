...
export const ru = {
  ...
  configForms: {
    ...
    dbQuery: {
      ...
      modeVisual: 'Собрать запрос',
      modeRawSql: 'SQL вручную',
      selectTable: 'С какой таблицей работать',
      loadingTables: 'Загрузка таблиц\u2026',
      noTables: 'Не нашли доступные таблицы.',
      ...
      selectConnectionHint:
        'Выберите PostgreSQL-подключение, и мы соберём запрос в визуальном режиме.',
      showJson: 'Тех. JSON',
      hideJson: 'Скрыть тех. JSON',
      introspectionError: 'Не удалось загрузить список таблиц и колонок.',
      metadataUnavailable:
        'В этой версии сервиса визуальная работа с PostgreSQL пока недоступна. Можно перейти к SQL вручную.',
      testUnavailable:
        'В этой версии сервиса проверка SQL из редактора пока недоступна. Можно выполнить сценарий обычным запуском.',
      switchToRawSql: 'Перейти к SQL вручную',
      opSelect: 'Прочитать',
      opInsert: 'Добавить',
      opUpdate: 'Изменить',
      opDelete: 'Удалить',
    ...
    rawJson: {
      ...
      invalidJson: 'Невалидный JSON',
      expertEyebrow: 'Для профи',
      expertDescription:
        'Открывайте ручной JSON только если визуальной формы не хватает.',
    },
    templatedInput: {
